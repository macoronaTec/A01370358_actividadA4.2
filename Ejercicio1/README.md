...
`docker build -t actividad4.2.1 .  Construye la el contenedor con la imagen.`

`docker run --rm -v "C:\Maestría\Quinto-trimestre\Pruebas de software\Semana4\Proyecto\Ejercicio1\datos":/app/datos actividad4.2.1 Ejecuta el contenedor con la imagen y genera el resultado.`
