...
|---------|-------------|
| `docker build -t actividad4.2.2 .` | Construye la el contenedor con la imagen. |
| `docker run --rm -v "C:\Maestría\Quinto-trimestre\Pruebas de software\Semana4\Proyecto\Ejercicio2\datos":/app/datos actividad4.2.2` | Ejecuta el contenedor con la imagen y genera el resultado. |
...
#CMD ["python", "convert_numbers.py"]
# Comando para ejecutar pylint al iniciar
CMD ["pylint", "convert_numbers.py"]
